...
if uploaded_file is not None:
    try:
        ...
        if preprocess_button:
            try:
                ...
                with st.spinner("🔄 Preprocessing data..."):
                    ...
                    st.session_state.categorical_features_selected = categorical_features_selected
                    st.session_state.numeric_features_selected = numeric_features_selected
                    st.session_state.selected_features = selected_features
                    st.session_state.target_column = target_column
        ...
        if train_button:
            try:
                # Verify that preprocessing data exists
                if st.session_state.X_train is None or st.session_state.model is None:
                    st.error("❌ Preprocessing data is missing. Please click 'Data Preprocessing' again.")
                    st.stop()
